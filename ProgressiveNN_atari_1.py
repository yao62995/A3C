...
tf.app.flags.DEFINE_string("train_dir", "./models/experiment_pnn/column_1", "gym environment name")
...
tf.app.flags.DEFINE_integer("t_train", 5e7, "train max time step")
...
class A3CNet(object):
    def __init__(self, state_shape, action_dim, scope, column_id=1):
        with tf.device("/gpu:%d" % flags.gpu):
            ...
            with tf.variable_scope(scope) as scope:
                ...
                with tf.variable_scope("col_%d_policy" % column_id):
                    pi_fc_1, self.pi_w1, self.pi_b1 = full_connect(fc_1, (256, 256), "pi_fc1", with_param=True)
                ...
                with tf.variable_scope("col_%d_value" % column_id):
                    v_fc_1, self.v_w1, self.v_b1 = full_connect(fc_1, (256, 256), "v_fc1", with_param=True)
